...
const CACHE = 'vcache-v22';   // v22：竖屏手机布局与顶栏文字修复
const ASSETS = ['./', './index.html', './manifest.json', './icon-192.png', './icon-512.png', './assets/redraw_manifest.json', './assets/skill_signature_manifest.json', './assets/syn/synergy-atlas.png', './assets/fx/v3-blade.png', './assets/fx/v3-arc.png', './assets/fx/v3-ward.png', './assets/fx/v3-void.png', './assets/ui/star-stage-icon.svg', './tools/bot_strategy.js', './tools/idol-ui.css?v=2', './tools/idol-ui.js?v=1', './tools/idol-redesign.css?v=2', './tools/idol-ui-redesign.js?v=1', './assets/ui/idol-sky-stage.png', './assets/ui/idol-arena-v2.png'];
