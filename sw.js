...
const CACHE = 'vcache-v54-campaign-final';   // v54：战役征服 v2（规则/地图/美术/平衡校准）
const INDEX_ASSET = './index.html?v=54';
const ASSETS = ['./tools/solo-modes.js?v=3', './tools/campaign-map.js?v=2', './tools/solo-ui.js?v=3', './tools/solo-ui.css?v=3', './tools/solo-host.js?v=5', './tools/daily-curses.js?v=2', './', INDEX_ASSET, './manifest.json', './icon-192.png', './icon-512.png', './assets/redraw_manifest.json', './assets/skill_signature_manifest.json', './assets/syn/synergy-atlas.png', './assets/fx/v3-blade.png', './assets/fx/v3-arc.png', './assets/fx/v3-ward.png', './assets/fx/v3-void.png', './assets/ui/star-stage-icon.svg', './tools/bot_strategy.js?v=8', './tools/idol-ui.css?v=2', './tools/idol-ui.js?v=1', './tools/idol-redesign.css?v=10', './tools/idol-ui-redesign.js?v=5', './tools/mobile-stage.css?v=2', './tools/idol-dark.css?v=3', './assets/ui/idol-sky-stage.png', './assets/ui/idol-arena-v2.png', './assets/ui/idol-arena-night.png', './assets/campaign/act1.webp', './assets/campaign/act2.webp', './assets/campaign/act3.webp', './assets/campaign/act4.webp', './assets/campaign/boss1.webp', './assets/campaign/boss2.webp', './assets/campaign/boss3.webp', './assets/campaign/boss4.webp'];
